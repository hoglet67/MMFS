...
_INCLUDE_CMD_BACKUP_=TRUE
_INCLUDE_CMD_COMPACT_=TRUE
_INCLUDE_CMD_COPY_=TRUE
_INCLUDE_CMD_DELETE_=TRUE
_INCLUDE_CMD_DESTROY_=TRUE
_INCLUDE_CMD_FORM_VERIFY_=TRUE
_INCLUDE_CMD_FREE_MAP_=TRUE
_INCLUDE_CMD_RENAME_=TRUE
_INCLUDE_CMD_TITLE_=TRUE
_INCLUDE_CMD_WIPE_=TRUE
ELSE
_INCLUDE_CMD_ACCESS_=FALSE
_INCLUDE_CMD_BACKUP_=FALSE
_INCLUDE_CMD_COMPACT_=FALSE
_INCLUDE_CMD_COPY_=FALSE
_INCLUDE_CMD_DELETE_=FALSE
_INCLUDE_CMD_DESTROY_=FALSE
_INCLUDE_CMD_FORM_VERIFY_=FALSE
_INCLUDE_CMD_FREE_MAP_=FALSE
_INCLUDE_CMD_RENAME_=FALSE
_INCLUDE_CMD_TITLE_=FALSE
_INCLUDE_CMD_WIPE_=FALSE
ENDIF
